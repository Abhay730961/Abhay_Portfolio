...
console.log(`%c${isDarkMode ? '🌙' : '☀️'} Welcome to Abhay Kumar Rajbhar's Portfolio`, 
    `color: ${isDarkMode ? '#60a5fa' : '#2563eb'}; font-size: 16px; font-weight: bold; padding: 10px;`);
console.log('%c📧 Feel free to reach out at: Ak5934231@gmail.com', 
